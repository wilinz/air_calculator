...
class SelectableMath extends StatelessWidget {
  ...
  /// Optional external [MathController]. When provided, the caller owns its
  /// lifecycle and can listen to selection / AST changes externally.
...
class InternalSelectableMath extends StatefulWidget {
  ...
  final MathController? externalController;
...
class InternalSelectableMathState extends State<InternalSelectableMath>
  ...
  void didUpdateWidget(InternalSelectableMath oldWidget) {
    ...
    } else if (widget.ast != controller.ast) {
      controller.ast = widget.ast;
    }
